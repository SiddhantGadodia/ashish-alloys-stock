...
const emptyInstr = { date: "", grade: "", size: "", quantity: "", make: "", uidNo: "", pieces: "", supplyCondition: "", locationFrom: "", locationTo: "", remarks: "", description: "" };
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        {showInstr && (
          <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-6 shadow-sm">
            <h2 className="text-base font-semibold mb-4">Stage 1 — Issue Instruction</h2>
            <form onSubmit={submitInstruction} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <Field label="Description" required><DynamicSelect field="description" value={instrForm.description} onChange={(v) => setI("description", v)} required /></Field>
                ...
                <Field label="Location From" required><DynamicSelect field="location" value={instrForm.locationFrom} onChange={(v) => setI("locationFrom", v)} required /></Field>
                ...
                return (
                  <tr key={e.id} className="border-t border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 flex gap-2 flex-wrap">
                      ...
                      {e.status === "instruction" && <button onClick={() => { setActualsId(e.id); setActForm(emptyInstr); setError(""); }} className="text-amber-600 hover:underline text-xs">Fill Actuals</button>}
